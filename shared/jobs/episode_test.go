...
func TestMatchesEpisodeFile(t *testing.T) {
	tests := []struct {
		...
		{name: "special metadata fallback", job: &Job{Season: 0, Episode: 2}, fileName: "opaque-special.mkv", season: 0, episode: 2, want: true},
		{name: "metadata fallback rejects wrong season", job: &Job{Season: 0, Episode: 2}, fileName: "opaque-special.mkv", season: 1, episode: 2},
